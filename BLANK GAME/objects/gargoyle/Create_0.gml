...
dodging = false; //This is set to true when the player is dodging, check this in the collisions that do damage, reset in alarm 2
...
active = false; //If this is the gargoyle being controlled
